...
Mat_Stack = write_stack_period(["BK7"], ["W-Al2O3", "SiO2"], 1) # Creation of the Stack 
# Choice of optimization method
algo = DEvol # Callable. Name of the optimization method 
...
Th_Substrate = 1e6 # Substrat thickness, in nm 
# Plage des épaisseurs des couches minces, en nm
Th_range = (0, 350) # en nm. Plage identique pour chaque couches minces pour générée la 1ere population 
...
#%% Hyperparameters for optimisation method
...
precision_AlgoG = 1e-5 # accurency for stop the optimisation processs for some optimization method
...
# I add values to parameters (dictionary used to transmit variables) 
...
if __name__=="__main__":
    ...
    if language == "en":
        with open(filename, "w") as file:
            ...
            file.write("Number of launches: " + str(nb_run) + "\n")
