...
Comment = "Tutorial : anti-reflective coating for human eye, with research of the best theorical refractiv index"  # Comment to be written in the simulation text file
Mat_Stack = ["BK7"]   
...
Wl = np.arange(280 , 805, 5) # /!\ Last value is not included in the array
...
if evaluate.__name__ == "evaluate_T_visvis":
