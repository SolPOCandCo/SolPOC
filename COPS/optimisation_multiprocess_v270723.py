...
nb_generation = 5 # Number of generation/iteration. For DEvol is also used to calculate the budget (nb_generation * pop_size)
...
nb_run = 2 # Number of run
cpu_used = 2  # Number of CPU used. /!\ be "raisonable", regarding the real number of CPU your computer
