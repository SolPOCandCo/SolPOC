...
def run_problem_solution(i):
    ...
    # make copy of parameter dictionary to set an individual seed for this run
    # (if a copy was not made, the seed change would interfere with different runs, as they all would refer to the same dictionary object)
    parameters = parameters.copy()
    parameters['seed'] = get_seed_for_run(i, nb_run,
                                           initial_seed=parameters['seed'])
