...
Comment = "Solar mirror made of Al with 5 bilayers" # Comment to be written in the simulation text file
Mat_Stack = write_stack_period(["BK7", "Al_Rakic"], ["SiO2", "TiO2"], 5)
