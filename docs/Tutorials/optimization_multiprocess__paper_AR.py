...
Comment = "Antireflective coatings made of 3 layers " # Comment to be written in the simulation text file
Mat_Stack = ["BK7", "air-SiO2", "air-SiO2", "air-SiO2"]
...
nb_generation = 50 # Number of generation/iteration. For DEvol is also used to calculate the budget (nb_generation * pop_size)
